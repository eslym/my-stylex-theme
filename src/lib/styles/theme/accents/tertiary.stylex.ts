...
export const accentTertiary = stylex.createTheme(radixColors, {
    ...
    accentA2: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.1255 0.3686 / 0.032), color(display-p3 0.7137 0.8235 0.9922 / 0.07))'
    },
    accentLightA2: {
        default: '#18346d09',
    ...
    accentA3: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.0039 0.1176 0.349 / 0.068), color(display-p3 0.8196 0.8902 0.9961 / 0.111))'
    },
    accentLightA3: {
        default: '#09316713',
    ...
    accentA4: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.149 0.3294 / 0.108), color(display-p3 0.8392 0.8902 1 / 0.147))'
    },
    accentLightA4: {
        default: '#0430651d',
    ...
    accentA5: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.1333 0.3216 / 0.148), color(display-p3 0.8471 0.8902 1 / 0.18))'
    },
    accentLightA5: {
        default: '#02295e27',
    ...
    accentA6: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.1255 0.3137 / 0.188), color(display-p3 0.8902 0.9255 1 / 0.217))'
    },
    accentLightA6: {
        default: '#01255931',
    ...
    accentA7: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.1137 0.2902 / 0.244), color(display-p3 0.9137 0.9412 1 / 0.274))'
    },
    accentLightA7: {
        default: '#03275641',
    ...
    accentA8: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.0039 0.1176 0.2902 / 0.34), color(display-p3 0.949 0.9569 1 / 0.372))'
    },
    accentLightA8: {
        default: '#01235459',
    ...
    accentA9: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.051 0.1373 / 0.696), color(display-p3 0.8824 0.9255 1 / 0.67))'
    },
    accentLightA9: {
        default: '#001026b4',
    ...
    accentA10: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.0471 0.1255 / 0.756), color(display-p3 0.8784 0.9216 1 / 0.621))'
    },
    accentLightA10: {
        default: '#000f23c3',
    ...
    accentA11: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.0549 0.1451 / 0.652), color(display-p3 0.898 0.9333 1 / 0.756))'
    },
    accentLightA11: {
        default: '#02122ca9',
    ...
    accentA12: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0 0.0235 0.0549 / 0.86), color(display-p3 0.9333 0.9569 1 / 0.968))'
    },
    accentLightA12: {
        default: '#010811dd',
