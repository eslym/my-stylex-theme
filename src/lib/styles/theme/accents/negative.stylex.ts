...
export const accentNegative = stylex.createTheme(radixColors, {
  ...
  accentA1: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.7373 0 0 / 0.016), color(display-p3 0.9765 0 0 / 0.021))",
  },
  accentLightA1: {
    default: "#fb2f2f05",
  ...
  accentA2: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.8745 0 0 / 0.036), color(display-p3 0.9922 0.5451 0.6 / 0.07))",
  },
  accentLightA2: {
    default: "#ffcdcd33",
  ...
  accentA3: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.898 0.0431 0 / 0.092), color(display-p3 1 0.2824 0.3686 / 0.18))",
  },
  accentLightA3: {
    default: "#ffc1c166",
  ...
  accentA4: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.9294 0 0 / 0.152), color(display-p3 1 0.2078 0.3451 / 0.258))",
  },
  accentLightA4: {
    default: "#ffd2d3",
  ...
  accentA5: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.9098 0 0 / 0.212), color(display-p3 1 0.2471 0.3804 / 0.323))",
  },
  accentLightA5: {
    default: "#ffc3c4",
  ...
  accentA6: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.8706 0 0 / 0.276), color(display-p3 1 0.3294 0.4431 / 0.392))",
  },
  accentLightA6: {
    default: "#ff828699",
  ...
  accentA7: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.7961 0 0.0118 / 0.356), color(display-p3 1 0.3922 0.4824 / 0.49))",
  },
  accentLightA7: {
    default: "#f001095f",
  ...
  accentA8: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.7529 0 0.0196 / 0.464), color(display-p3 1 0.4078 0.498 / 0.654))",
  },
  accentLightA8: {
    default: "#e2020e7d",
  ...
  accentA9: {
    default: "light-dark(#ec003f, #ff637e)",
    [supports_p3]: "light-dark(color(display-p3 0.8157 0 0.1098 / 0.816), color(display-p3 1 0.4588 0.5373 / 0.927))",
  },
  accentLightA9: {
    default: "#ec003f",
  ...
  accentA10: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.7294 0 0.098 / 0.836), color(display-p3 1 0.4275 0.5098 / 0.89))",
  },
  accentLightA10: {
    default: "#d60038",
  ...
  accentA11: {
    default: "light-dark(#ce0035, #ff8e9d)",
    [supports_p3]: "light-dark(color(display-p3 0.698 0 0.0902 / 0.844), color(display-p3 1 0.6157 0.6549 / 0.939))",
  },
  accentLightA11: {
    default: "#ce0035",
  ...
  accentA12: {
    default: "light-dark(#6f001b, #ffd1d5)",
    [supports_p3]: "light-dark(color(display-p3 0.3569 0 0.0588 / 0.936), color(display-p3 1 0.851 0.8627 / 0.972))",
  },
  accentLightA12: {
    default: "#6f001b",
