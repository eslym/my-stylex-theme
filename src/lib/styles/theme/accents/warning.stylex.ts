...
export const accentWarning = stylex.createTheme(radixColors, {
  ...
  accentA1: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.7843 0.3922 0 / 0.02), color(display-p3 0.9137 0.0392 0 / 0.009))",
  },
  accentLightA1: {
    default: "#d07b2606",
  ...
  accentA2: {
    ...
    [supports_p3]: "light-dark(color(display-p3 1 0.9294 0.8314 / 0.6), color(display-p3 0.9882 0.8627 0.2314 / 0.062))",
  },
  accentLightA2: {
    default: "#fff2e1",
  ...
  accentA3: {
    ...
    [supports_p3]: "light-dark(color(display-p3 1 0.6471 0 / 0.2), color(display-p3 1 0.7608 0 / 0.131))",
  },
  accentLightA3: {
    default: "#ffe8b7",
  ...
  accentA4: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.9725 0.6667 0 / 0.36), color(display-p3 1 0.7294 0 / 0.188))",
  },
  accentLightA4: {
    default: "#ffdc97",
  ...
  accentA5: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.9647 0.651 0 / 0.476), color(display-p3 1 0.749 0.0706 / 0.237))",
  },
  accentLightA5: {
    default: "#ffd076",
  ...
  accentA6: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.9529 0.6078 0 / 0.568), color(display-p3 1 0.8 0.1333 / 0.294))",
  },
  accentLightA6: {
    default: "#ffc25b",
  ...
  accentA7: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.8627 0.5451 0 / 0.636), color(display-p3 1 0.8235 0.1765 / 0.376))",
  },
  accentLightA7: {
    default: "#ed9200b6",
  ...
  accentA8: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.8 0.502 0 / 0.788), color(display-p3 1 0.8314 0.2196 / 0.482))",
  },
  accentLightA8: {
    default: "#e19700",
  ...
  accentA9: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.7294 0.4392 0 / 0.812), color(display-p3 1 0.8275 0.2784 / 0.956))",
  },
  accentLightA9: {
    default: "#d08700",
  ...
  accentA10: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.6627 0.4 0 / 0.828), color(display-p3 1 0.8275 0.2784 / 0.907))",
  },
  accentLightA10: {
    default: "#c17c00",
  ...
  accentA11: {
    default: "light-dark(#9d6300, #ffce00)",
    [supports_p3]: "light-dark(color(display-p3 0.5255 0.3137 0 / 0.872), color(display-p3 1 0.8431 0.2824 / 0.968))",
  },
  accentLightA11: {
    default: "#9d6300",
  ...
  accentA12: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.2157 0.1333 0 / 0.904), color(display-p3 1 0.9373 0.7137 / 0.98))",
  },
  accentLightA12: {
    default: "#402800ee",
