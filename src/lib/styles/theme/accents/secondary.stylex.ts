...
export const accentSecondary = stylex.createTheme(radixColors, {
  ...
  accentA1: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.3294 0.6549 / 0.012), color(display-p3 0 0.0431 0.9961 / 0.037))",
  },
  accentLightA1: {
    default: "#3b7bbb04",
  ...
  accentA2: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.3294 0.9843 / 0.036), color(display-p3 0.2706 0.5725 0.9922 / 0.103))",
  },
  accentLightA2: {
    default: "#c8dcff33",
  ...
  accentA3: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.3294 0.9804 / 0.084), color(display-p3 0.2078 0.5098 1 / 0.233))",
  },
  accentLightA3: {
    default: "#8cb4ff33",
  ...
  accentA4: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.7529 0.8314 1 / 0.6), color(display-p3 0.1412 0.4706 1 / 0.343))",
  },
  accentLightA4: {
    default: "#d4e4ff",
  ...
  accentA5: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.4706 0.6471 1 / 0.4), color(display-p3 0.2196 0.5255 1 / 0.413))",
  },
  accentLightA5: {
    default: "#c2d9ff",
  ...
  accentA6: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.0392 1 / 0.2), color(display-p3 0.2902 0.5647 1 / 0.486))",
  },
  accentLightA6: {
    default: "#accbff",
  ...
  accentA7: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.298 0.9725 / 0.384), color(display-p3 0.3294 0.5961 1 / 0.572))",
  },
  accentLightA7: {
    default: "#93b8ff",
  ...
  accentA8: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.2745 0.9294 / 0.516), color(display-p3 0.3451 0.6 1 / 0.694))",
  },
  accentLightA8: {
    default: "#0055fa8e",
  ...
  accentA9: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.2275 0.949 / 0.824), color(display-p3 0.4118 0.6471 1 / 0.972))",
  },
  accentLightA9: {
    default: "#0000ff66",
  ...
  accentA10: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.1961 0.8196 / 0.844), color(display-p3 0.3725 0.6157 1 / 0.939))",
  },
  accentLightA10: {
    default: "#0045dded",
  ...
  accentA11: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.1922 0.8118 / 0.856), color(display-p3 0.5412 0.7255 1 / 0.976))",
  },
  accentLightA11: {
    default: "#0044dbf0",
  ...
  accentA12: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.0863 0.3373 / 0.908), color(display-p3 0.8275 0.898 1 / 0.988))",
  },
  accentLightA12: {
    default: "#001e5fef",
