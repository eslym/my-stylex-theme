...
export const accentPrimary = stylex.createTheme(radixColors, {
    ...
    accentA1: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.2471 0 0.9804 / 0.016), color(display-p3 0.0392 0 1 / 0.049))'
    },
    accentLightA1: {
        default: '#622ffb05',
    ...
    accentA2: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.9216 0.902 1 / 0.4), color(display-p3 0.4706 0.3373 0.9961 / 0.119))'
    },
    accentLightA2: {
        default: '#f0edff99',
    ...
    accentA3: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.8902 0.8706 1 / 0.6), color(display-p3 0.4824 0.298 1 / 0.258))'
    },
    accentLightA3: {
        default: '#ede9ff',
    ...
    accentA4: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.7451 0.6863 1 / 0.4), color(display-p3 0.4667 0.2431 1 / 0.368))'
    },
    accentLightA4: {
        default: '#e3dcff',
    ...
    accentA5: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.3137 0.1176 1 / 0.2), color(display-p3 0.502 0.298 1 / 0.425))'
    },
    accentLightA5: {
        default: '#daceff',
    ...
    accentA6: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.1961 0 0.9804 / 0.24), color(display-p3 0.5373 0.3569 1 / 0.482))'
    },
    accentLightA6: {
        default: '#cdbdff',
    ...
    accentA7: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.2039 0.0039 0.9686 / 0.332), color(display-p3 0.5569 0.3961 1 / 0.576))'
    },
    accentLightA7: {
        default: '#bca6ff',
    ...
    accentA8: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.2353 0 0.9569 / 0.468), color(display-p3 0.5686 0.4118 1 / 0.719))'
    },
    accentLightA8: {
        default: '#a784ff',
    ...
    accentA9: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.3569 0 0.9529 / 0.836), color(display-p3 0.651 0.5373 1 / 0.968))'
    },
    accentLightA9: {
        default: '#6100ffcc',
    ...
    accentA10: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.302 0 0.8196 / 0.848), color(display-p3 0.6235 0.502 1 / 0.935))'
    },
    accentLightA10: {
        default: '#5d01dddf',
    ...
    accentA11: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.302 0 0.8078 / 0.86), color(display-p3 0.7412 0.6588 1 / 0.976))'
    },
    accentLightA11: {
        default: '#5d01dae3',
    ...
    accentA12: {
        ...
        [supports_p3]:
            'light-dark(color(display-p3 0.1412 0 0.4039 / 0.924), color(display-p3 0.898 0.8706 1 / 0.988))'
    },
    accentLightA12: {
        default: '#2c006eef',
