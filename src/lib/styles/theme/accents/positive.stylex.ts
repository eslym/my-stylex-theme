...
export const accentPositive = stylex.createTheme(radixColors, {
  ...
  accentA1: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.7373 0.2471 / 0.016), color(display-p3 0 0.9137 0 / 0.009))",
  },
  accentLightA1: {
    default: "#26d07b06",
  ...
  accentA2: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.5725 0.2471 / 0.048), color(display-p3 0.5176 0.9922 0.6941 / 0.066))",
  },
  accentLightA2: {
    default: "#0e9f570e",
  ...
  accentA3: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.6039 0.2667 / 0.104), color(display-p3 0.4078 1 0.6902 / 0.139))",
  },
  accentLightA3: {
    default: "#04b0561f",
  ...
  accentA4: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.6078 0.2588 / 0.168), color(display-p3 0.3412 1 0.6824 / 0.196))",
  },
  accentLightA4: {
    default: "#01ac5431",
  ...
  accentA5: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.5843 0.2353 / 0.236), color(display-p3 0.3961 1 0.7059 / 0.254))",
  },
  accentLightA5: {
    default: "#03a75346",
  ...
  accentA6: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0.0039 0.5569 0.2431 / 0.324), color(display-p3 0.451 1 0.7255 / 0.315))",
  },
  accentLightA6: {
    default: "#01a35360",
  ...
  accentA7: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.5294 0.2353 / 0.44), color(display-p3 0.4863 1 0.7412 / 0.38))",
  },
  accentLightA7: {
    default: "#009b5484",
  ...
  accentA8: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.5255 0.2549 / 0.62), color(display-p3 0.4863 1 0.7412 / 0.466))",
  },
  accentLightA8: {
    default: "#009f61c5",
  ...
  accentA9: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.451 0.2078 / 0.732), color(display-p3 0.4549 1 0.7176 / 0.813))",
  },
  accentLightA9: {
    default: "#009966",
  ...
  accentA10: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.3961 0.1765 / 0.76), color(display-p3 0.4549 1 0.7059 / 0.768))",
  },
  accentLightA10: {
    default: "#008b5a",
  ...
  accentA11: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.3373 0.1451 / 0.788), color(display-p3 0.4549 1 0.7216 / 0.837))",
  },
  accentLightA11: {
    default: "#007b4e",
  ...
  accentA12: {
    ...
    [supports_p3]: "light-dark(color(display-p3 0 0.1255 0.0588 / 0.876), color(display-p3 0.7647 1 0.8706 / 0.939))",
  },
  accentLightA12: {
    default: "#002b19eb",
